...
Cleaned the dataset containing 13,368  trials, 1984–2020, 10 sponsors in Excel/Power Query — handling missing values, duplicates, format standardization, and calculated fields like Decade, Phase_Numeric, and Enrollment_Band. Analysis shows a 76.7% overall completion rate, Phase 3 trials leading volume (36.3%), GSK as the top sponsor by trial count (2,413) and completion rate (85.6%), and Oncology as the leading therapeutic area (17.9%).
